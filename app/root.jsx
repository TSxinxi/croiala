...
export default function App() {
  ...
  if (canUseDOM) {
    ...
    useEffect(() => {
      Sentry.init({
        dsn: "https://1c6321b50171b9bc4d2c32394ab5a971@o4506097284677632.ingest.sentry.io/4506098105516032",
        integrations: [
          new Sentry.BrowserTracing({
            // Set 'tracePropagationTargets' to control for which URLs distributed tracing should be enabled
            tracePropagationTargets: ["localhost", /^https:\/\/page.croiala.com\.io\/api/],
          }),
          new Sentry.Replay(),
        ],
